...
class SMCycleBannerView: UIView {
    ...
    private func initPageControl() {
        self.m_pageControl = UIPageControl(frame: CGRect(x: 0, y: self.m_scrollView!.frame.size.height - kPageControl, width: self.m_scrollView!.frame.size.width, height: kPageControl))
