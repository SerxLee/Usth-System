//
//  USPublicCommentTableViewCell.swift
//  Usth System
//
//  Created by Serx on 2017/6/13.
//  Copyright © 2017年 Serx. All rights reserved.
//

import UIKit

@objc protocol USPublicCommentTableViewCellDelegate: NSObjectProtocol {
    @objc optional func publicCommentTableViewCell(commentCell: USPublicCommentTableViewCell, didClickReplyBtn: UIButton)
    @objc optional func publicCommentTableViewCell(commentCell: USPublicCommentTableViewCell, didClickDiggBtn: UIButton)
}

class USPublicCommentTableViewCell: UITableViewCell {
    
    weak var delegate: USPublicCommentTableViewCellDelegate?
    ...
    private var _autherClassNameLab: UILabel?
    ...
    func layoutPageSubviews() {
        ...
        self.publishTimeLab!.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(self.classNameLab!.snp.top).offset(-6.0)
    ...
    static func getCellHeight(commentData: USComment?) -> CGFloat {
        var cellHeight: CGFloat = 10.0 + 10.0 + 25.0 + 10.0 + 22.0
    ...
    func classNameLabSizeToFit() {
        ...
        self.classNameLab!.snp.updateConstraints { (make) in
            make.width.equalTo(self.classNameLab!.bounds.size.width)
        }
    }
    //MARK: - ------Delegate View------
    ...
    func replyBtnDidClick(button: UIButton) {
        self.delegate?.publicCommentTableViewCell!(commentCell: self, didClickReplyBtn: button)
    }
    
    func diggBtnDidClick(button: UIButton) {
        self.delegate?.publicCommentTableViewCell!(commentCell: self, didClickDiggBtn: button)
    }
